  ...
  return (
    <Card>
      <CardHeader className="flex items-center justify-between space-y-0 border-b p-0 sm:flex-row">
       ...
       <CardContent className="relative px-2 sm:p-6 flex justify-center items-center h-[250px] w-full overflow-hidden">
        <div
          className={`absolute top-0 left-0 w-full h-full flex justify-center items-center bg-black bg-opacity-500 text-white text-9xl font-semibold ${
            commingSoon ? "" : "hidden"
          }`}
        >
          Comming Soon
